---
name: vault-coherence-and-drift
description: "Quarterly audit. Stale entries (updated > 90 days), contradictions across docs, broken cross-links, agent-memory-vs-vault divergence. Surfaces a punch list the operator works through. [SKELETON — full SKILL.md body shipping in a follow-up iteration of pepe-knowledge-management. The description above is the intended scope.]"
